...
% Modification by Hubert Taieb, 2021-03-30
% Upon packaging the app, this yields an error, so one safety nest added
% Set logging level
try
    javaMethod('enableLogging', 'loci.common.DebugTools', ip.Results.level);
catch ME
    msg = 'Error in bfInitLogging, this part is skipped';
    disp(msg);
    disp(ME.message);
end
